...
public class DataSeeder {
    ...
    CommandLineRunner seedInitialData(
        ...
        return args -> {
            ...
            if (productRepository.count() == 0) {
                seedProduct(productRepository, stockItemRepository, product(
                        "Ao thun cotton",
    ...
    private Product product(String name, String description, String imageUrl, int price) {
    ...
    private void seedProduct(
        ...
        stockItem.setProductId(savedProduct.getId());
